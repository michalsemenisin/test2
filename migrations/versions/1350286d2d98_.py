...
Revision ID: 1350286d2d98
Revises: None
Create Date: 2019-10-09 10:51:16.359419

"""

# revision identifiers, used by Alembic.
revision = '1350286d2d98'
down_revision = None
...
def upgrade():
    ...
    op.create_table('vozidla',
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('typ', sa.String(), nullable=False),
    sa.Column('spz', sa.String(), nullable=False),
    sa.PrimaryKeyConstraint('id', name='pk_vozidla')
    )
    op.create_index('ix_vozidla_spz', 'vozidla', ['spz'], unique=True)
    op.create_index('ix_vozidla_typ', 'vozidla', ['typ'], unique=False)
...
def downgrade():
    ...
    op.drop_table('users')
    op.drop_index('ix_vozidla_typ', table_name='vozidla')
    op.drop_index('ix_vozidla_spz', table_name='vozidla')
    op.drop_table('vozidla')
    ### end Alembic commands ###
